class PayloadSamples
  ...
  def self.initial_payloads
    [{"payload"=> "{\"url\":\"http://jumpstartlab.com/index\",\"requestedAt\":\"2013-02-16 21:38:28 -0700\",\"respondedIn\":37,\"referredBy\":\"http://jumpstartlab.com\",\"requestType\":\"GET\",\"parameters\":[],
      ...
      {"payload"=> "{\"url\":\"http://jumpstartlab.com/index\",\"requestedAt\":\"2013-02-16 21:38:30 -0700\",\"respondedIn\":14,\"referredBy\":\"http://jumpstartlab.com\",\"requestType\":\"GET\",\"parameters\":[],
